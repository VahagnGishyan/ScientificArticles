...
namespace dsrc
{
	namespace shared_test
	{
		...
		{
			dsrc::shared_ptr<valueT> ptr = nullptr;
		}
		...
		{
			dsrc::shared_ptr<valueT> ptr = nullptr;
			dsrc::shared_ptr<valueT>::free(ptr);
		}
		...
		{
			dsrc::shared_ptr<valueT> ptr = nullptr;
			ptr = std::move(dsrc::shared_ptr<valueT>::make(args...));
			dsrc::shared_ptr<valueT>::free(ptr);
		}
		...
		{
			dsrc::shared_ptr<valueT> ptr1 = nullptr;
			dsrc::shared_ptr<valueT> ptr2 = nullptr;

			ptr1 = std::move(dsrc::shared_ptr<valueT>::make(args...));
			assert(ptr1 != nullptr);
			ptr2 = std::move(ptr1);
			dsrc::shared_ptr<valueT>::free(ptr2);
		}

		/////////////////////////////////////////////////////////

		template <typename valueT>
		static void success_test_06_func(dsrc::shared_ptr<valueT>& ptr)
		{
			dsrc::shared_ptr<valueT>::free(ptr);
		}
		...
		template <typename valueT>
		static void success_test_07_func(dsrc::shared_ptr<valueT> ptr)
		{
			dsrc::shared_ptr<valueT>::free(ptr);
		}
		...
		{
			dsrc::shared_ptr<valueT> ptr = dsrc::shared_ptr<valueT>::make(args...);
			dsrc::shared_ptr<valueT>::free(ptr);
		}
		...
		{
			dsrc::shared_ptr<valueT> ptr1 = dsrc::shared_ptr<valueT>::make(args...);
			dsrc::shared_ptr<valueT> ptr2 = ptr1;
			dsrc::shared_ptr<valueT> ptr3 = ptr1;
			dsrc::shared_ptr<valueT>::free(ptr1);
		}
		...
		static void success_test_11(ArgsT&&... args)
		{
			...
			dsrc::shared_ptr<valueT>::free(ptr3);
		}
		...
		{
			dsrc::shared_ptr<valueT> ptr1 = dsrc::shared_ptr<valueT>::make(args...);
			dsrc::shared_ptr<valueT> ptr2 = std::move(ptr1);
		...
		static void success_test_13(ArgsT&&... args)
		{
			struct SomeT
			{
				SomeT(ArgsT&&... args) : ptr(dsrc::shared_ptr<valueT>::make(args...)) {}
				~SomeT() { dsrc::shared_ptr<valueT>::free(ptr); }

				dsrc::shared_ptr<valueT>  data_obj() { return (ptr); }
				dsrc::shared_ptr<valueT>& data_ref() { return (ptr); }

			private:
				dsrc::shared_ptr<valueT> ptr;
			};

			SomeT obj(args...);

			dsrc::shared_ptr<valueT> ptr1 = obj.data_obj();
			dsrc::shared_ptr<valueT> ptr2 = obj.data_ref();

			dsrc::shared_ptr<valueT> ptr3 = SomeT(args...).data_obj();
			dsrc::shared_ptr<valueT> ptr4 = SomeT(args...).data_ref();
		}
		...
		static void success_test_14(ArgsT&&... args)
		{
			...
			public:
				...
				static bool tying(dsrc::shared_ptr<SomeT>& h1, dsrc::shared_ptr<SomeT>& h2)
				{
			...
			auto ptr1 = dsrc::shared_ptr<SomeT>::make();
			auto ptr2 = dsrc::shared_ptr<SomeT>::make();

			SomeT::tying(ptr1, ptr2);
			//memleak

			dsrc::shared_ptr<SomeT>::free(ptr1);
			dsrc::shared_ptr<SomeT>::free(ptr2);
		}
		...
		static void fail_test_01(ArgsT&&... args)
		{
			...
			{
				dsrc::shared_ptr<valueT> ptr = nullptr;
				ptr = dsrc::shared_ptr<valueT>::make(args...);
				dsrc::shared_ptr<valueT>::free(ptr);
				valueT value = *ptr;
			}
			catch (...)
