...
fn func0() -> Result<i32, String> { return create_err(); }
fn func1() -> Result<i32, String> { return func0(); }
fn func2() -> Result<i32, String> { return func1(); }
fn func3() -> Result<i32, String> { return func2(); }
fn func4() -> Result<i32, String> { return func3(); }
fn func5() -> Result<i32, String> { return func4(); }
fn func6() -> Result<i32, String> { return func5(); }
fn func7() -> Result<i32, String> { return func6(); }
fn func8() -> Result<i32, String> { return func7(); }
fn func9() -> Result<i32, String> { return func8(); }
...
fn main() {
	println!("Start \"ten_funcs\" main()\n");
	
	let mut test :Test = Test::new(10 as i32, 1000000 as i32, String::from("ten_function")); 
	//test.testCount = 10;
